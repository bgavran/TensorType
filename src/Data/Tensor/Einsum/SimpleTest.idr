module Data.Tensor.Einsum.SimpleTest
...
-- Simple test function that shows how to use VariableFind
-- This function has variables in scope that we can test with
export
testVariableFind : Int -> String -> Bool -> ()
testVariableFind x y z = %runElab do
...
export
testVariableReferences : Int -> String -> Bool -> ()
testVariableReferences x y z = %runElab do
