...
SelfAttentionMat : {default False causalMask : Bool} ->
  Tensor [SeqLen, NumFeatures] Double -\->
  Tensor [SeqLen, NumFeatures] Double
...
inputMatrix : Tensor [SeqLen, NumFeatures] Double
inputMatrix = ># [ [1, 3, 3, 2]
                 , [2, -3, 2, 1]
                 , [0, 0.3, 10, 9]]
...
params : SelfAttentionParams NumFeatures {a=Double}
...
outputMatrix : Tensor [SeqLen, NumFeatures] Double
...
SelfAttentionTree : Tensor [InputStructure, NumFeatures] Double -\->
  Tensor [InputStructure, NumFeatures] Double
...
inputTree : Tensor [InputStructure, NumFeatures] Double
...
outputTree : Tensor [InputStructure, NumFeatures] Double
